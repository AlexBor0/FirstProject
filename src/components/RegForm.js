...
const RegForm = ({pF, lo, er, fReg, setRO, rO, inputErrors, getDataItems, resetRegForm, setRegUser}) => {
    ...
    return(
        ...
        >
            ...
            <fieldset className="statusOption"
            onChange={(e) => {
            ...
            >
                ...
                <div className="statusWrapper">
                    <div>
                        <input  id="employer" name="userStatus" type="radio" value="employer" className="radioInput"  />
                        <label htmlFor="employer">Работодавець</label>
                    </div>
                    <div>
                        <input  id="candidate" name="userStatus" type="radio" value="candidate" className="radioInput" defaultChecked/>
